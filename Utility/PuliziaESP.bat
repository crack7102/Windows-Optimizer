...
echo ================================================
echo [1/5] Limpieza de archivos temporales del sistema...
...
echo [2/5] Limpieza profunda y vaciado de Prefetch...
...
echo [3/5] Limpieza de logs de eventos de Windows...
for /F "tokens=*" %%G in ('wevtutil el') do wevtutil cl "%%G" >nul 2>&1
timeout /t 1 >nul

echo [4/5] Limpieza de caché de Windows Update...
...
echo [5/5] Limpieza final de Windows...
