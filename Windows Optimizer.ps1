...
switch ($lang) {
    "ITA" {
        ...
        Add-BatButton "Disinstalla App" 390 { Start-Process powershell -ArgumentList "-ExecutionPolicy Bypass -File `"$UtilityPath\DisinstallaApp.ps1`"" -Verb RunAs }
    ...
    "ENG" {
        ...
        Add-BatButton "Uninstall App" 390 { Start-Process powershell -ArgumentList "-ExecutionPolicy Bypass -File `"$UtilityPath\DisinstallaApp.ps1`"" -Verb RunAs }
    ...
    "ESP" {
        ...
        Add-BatButton "Desinstalar App" 390 { Start-Process powershell -ArgumentList "-ExecutionPolicy Bypass -File `"$UtilityPath\DisinstallaApp.ps1`"" -Verb RunAs }
...
$formLang.Text = "Windows Optimizer"
$formLang.Size = New-Object System.Drawing.Size(400,150)
...
$labelLang.Location = New-Object System.Drawing.Point(20,10)
$formLang.Controls.Add($labelLang)

$iconsPath = Join-Path $PSScriptRoot "Utility\WOIcons"
$btnWidth = 110; $btnHeight = 50; $spacing = 15; $startX = 20; $yPos = 50
...
"@
    [System.Windows.Forms.MessageBox]::Show($welcomeText,"Windows Optimizer",[System.Windows.Forms.MessageBoxButtons]::OK,[System.Windows.Forms.MessageBoxIcon]::Information)
